    ...
    <div class={`${styles.pageContainer} ${styles.dynamicPage}`}>
      ...
      <div class={styles.panel}>
        ...
        <pre class={styles.codeBlock}>
          <code class={styles.inlineCode}>{JSON.stringify(pageState.params, null, 2)}</code>
        </pre>
      </div>
      ...
      <div class={styles.panel}>
        ...
        <div class={styles.textBlock}>
          The segment <code class={styles.inlineCode}>:foo</code> is read from the URL and validated
