  ...
  return (
    <div class={`${styles.pageContainer} ${styles.preventPage}`}>
      ...
      <div class={styles.panel}>
        <div class={styles.sectionTitle}>beforeEnter redirects</div>
        <div class={styles.textBlock}>This page shows a route guard that redirects on entry.</div>
        <div class={styles.textBlock}>
          Entering from <code class={styles.inlineCode}>dynamic</code> redirects to{' '}
          <code class={styles.inlineCode}>static</code>. Browser Back/Forward entries are
      ...
      <div class={styles.panel}>
        ...
        <div class={styles.panelItem}>
          ...
          <div class={styles.itemBody}>
            <div class={styles.textBlock}>
              <div class={styles.labelStrong}>From dynamic:</div> redirected to static.
            </div>
          </div>
        </div>
        <div class={styles.panelItem}>
          ...
          <div class={styles.itemBody}>
            <div class={styles.textBlock}>
              <div class={styles.labelStrong}>Back/Forward:</div> redirected entries are replaced,
              not pushed.
            </div>
          </div>
        </div>
